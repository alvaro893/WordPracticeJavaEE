...
@NamedQueries({
    ...
    @NamedQuery(name = "Translations.findById", query = "SELECT t FROM Translations t WHERE t.id = :id"),
    @NamedQuery(name = "Translations.findByTranslation", query = "SELECT t FROM Translations t WHERE t.translation = :translation")})
public class Translations implements Serializable {
    ...
    public Translations(Integer id) {
        this.id = id;
    }
